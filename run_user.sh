...
$UNITY_PATH -runTests -batchmode -projectPath client/unity/my-first-unity-project/ -testResults ./test_results.xml -testPlatform PlayMode -testFilter GoForward60Seconds & # Unity client
