...
#pragma warning restore 0649
        ...
        public void Run(SignalingSettings settings)
        {
            if (m_running || handlers.Count == 0)
            {
                Debug.LogWarning($"SignalingManager is already running");
                return;
            }
            ...
            )
        {
            ...
            m_instance.onStart += () => onStart?.Invoke();
        ...
        void Awake()
        {
            ...
            {
                Debug.Log("not starting on awake");
                return;
            }
